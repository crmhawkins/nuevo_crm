...
<head>
    ...
    <title>Informe SEO Disponible - Hawkins</title>
        ...
        <div class="email-card">
            <div class="header">
                <div class="header-content">
                    ...
                    <p>Su análisis de posicionamiento está listo</p>
                </div>
            </div>
            ...
            <div class="content">
                <div class="welcome-text">
                    ...
                    <p>Nos complace informarle que hemos generado un nuevo informe SEO detallado para su sitio web.</p>
                </div>
                ...
                <p>Para acceder a su informe completo con análisis avanzado, métricas de rendimiento y recomendaciones personalizadas, necesitará el siguiente código de acceso:</p>
                ...
                <div class="info-text">
                    <p><strong>💡 Importante:</strong> Guarde este código de acceso de forma segura, ya que lo necesitará para acceder a futuros informes y actualizaciones.</p>
                </div>

                <p>Su informe incluye:</p>
                <ul style="color: #4b5563; line-height: 1.8;">
                    <li>📈 Análisis de posiciones de keywords</li>
                    <li>📊 Métricas de rendimiento SEO</li>
                    <li>🎯 Recomendaciones personalizadas</li>
                    <li>📋 Comparativas históricas</li>
                    <li>🔍 Análisis de competencia</li>
                </ul>

                <p style="margin-top: 30px;">Si tiene alguna pregunta sobre su informe, no dude en contactarnos.</p>
                
                <p style="color: #6b7280; font-size: 0.95rem;">Saludos cordiales,<br><strong>Equipo SEO Hawkins</strong></p>
            </div>
