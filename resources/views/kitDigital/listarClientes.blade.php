                            ...
                            <table class="table table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr wire:key='{{rand()}}' style="--bs-table-bg: {{$item->estados->color}} !important; --bs-table-color: {{$item->estados->text_color}} !important">
                                        ...
                                        <td style="max-width: 98px"><input data-id="{{$item->id}}" type="date" name="sasak2" id="sasak2" value="{{ $item->sasak2 }}" style="height: fit-content;background-color: {{$item->estados->color}}; color: {{$item->estados->text_color}}; border:none;margin-bottom: 0 !important;font-size: 0.75rem;"></td>
