                            ...
                            <div class="card card-sm" data-toggle="modal" data-target="#exampleModalCenter" style="cursor:pointer;">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between position-relative">
                                        <div>
                                            <span class="d-block display-5 font-weight-400 text-dark">{{$dataBudgets['total']}}+</span>
                                        </div>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="card card-sm">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between position-relative">
                                        <div>
                                            <span class="d-block display-5 font-weight-400 text-dark">€ <span class="counter-anim">{{$countTotalBudgets}}</span></span>
                                        </div>
                                        <div class="position-absolute r-0">
                            ...
                            <div class="card card-sm" data-toggle="modal" data-target="#ModalFacturacionanual" style="cursor:pointer;">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-end justify-content-between">
                                        <div>
                                            <span class="d-block display-5 font-weight-400 text-dark">€ {{$dataFacturacionAnno['total']}}</span>
                                        </div>
                                        <div>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="card card-sm">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-end justify-content-between">
                                        <div>
                                            <span class="d-block display-5 font-weight-400 text-dark">{{$totalBeneficioAnual}}</span>
                                        </div>
                                        <div>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="card card-sm" data-toggle="modal" data-target="#ModalGastosAsociados" style="cursor:pointer;">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-end justify-content-between">
                                        <div>
                                            <span class="d-block display-5 font-weight-400 text-dark">{{$dataGastosComunesAnual['total']}}</span>
                                        </div>
                                        <div>
                                            <span class="text-danger font-12 font-weight-600">0%</span>
                                        </div>
