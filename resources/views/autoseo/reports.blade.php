...
<body class="min-h-screen pattern-bg">
    ...
    <!-- Footer -->
    <footer class="mt-12 bg-white/80 backdrop-blur-sm border-t border-gray-200">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center">
                <div class="text-sm text-gray-500">
                    © 2024 Hawkins. Todos los derechos reservados.
                </div>
                <div class="flex space-x-6">
                    <a href="https://hawkins.es/politica-privacidad" class="text-sm text-gray-500 hover:text-gray-900">
                        Política de Privacidad
                    </a>
                    <a href="https://hawkins.es/aviso-legal" class="text-sm text-gray-500 hover:text-gray-900">
                        Aviso Legal
                    </a>
                </div>
            </div>
