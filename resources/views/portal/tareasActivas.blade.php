...
.table-clientportal tbody tr>td { background-color: rgba(237, 239, 243, .49); font-size: 14px; color: #424b5a; padding: 16px 20px; margin: 10px; }
          ...
          <div class="row">
           ...
           <div class="row mt-4">
            <div class="col-12 text-end">
              ...
              <h5><strong>Tiempo Restante: {{$tiempoTotalFormato}}</strong></h5>
            </div>
          </div>
