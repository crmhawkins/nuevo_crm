                                ...
                                <div class="row d-flex">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control @error('budget_id') is-invalid @enderror" id="budget_id" value="{{ $factura->budget->reference ??  ($factura->budget_id ? $factura->budget->reference : 'Sin presupuesto asignado') }}" name="budget_id" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control @error('client_id') is-invalid @enderror" id="client_id" value="{{ ($factura->cliente->company ?? $factura->cliente->name) ??  ($factura->client_id ? 'Cliente borrado' : 'Sin cliente asignado') }}" name="client_id" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group mb-3">
...
<script>
    $(document).ready(function() {
        ...
        $('#retenciones_porcentaje').on('input change', function() {
            console.log('Cambio detectado en retenciones_porcentaje:', $(this).val());
            calcularRetenciones();
        });
