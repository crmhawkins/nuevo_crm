                                ...
                                <div class="row d-flex">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control @error('budget_id') is-invalid @enderror" id="budget_id" value="{{ $factura->budget->concept ?? $factura->budget->reference ?? ($factura->budget_id ? 'Presupuesto borrado' : 'Sin presupuesto asignado') }}" name="budget_id" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group mb-3">
