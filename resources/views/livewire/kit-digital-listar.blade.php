        ...
        <table class="table table-sm">
            ...
            <tbody>
                ...
                <tr  wire:key='{{rand()}}' style="--bs-table-bg: {{$item->estados->color}} !important; --bs-table-color: {{$item->estados->text_color}} !important">
                    ...
                    <td style="max-width: 50px"><input data-id="{{$item->id}}" type="number" name="importe" min="100" max="100000" id="importe" value="{{ $item->importe }}" style="height: fit-content;background-color: {{$item->estados->color}}; color: {{$item->estados->text_color}}; border:none;margin-bottom: 0 !important;font-size: 0.75rem; text-align: center;width: 50px"></td>
