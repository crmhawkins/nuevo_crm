...
@section('content')
    ...
    <div class="page-heading card" style="box-shadow: none !important" >
        ...
        <div class="page-title card-body">
            <div class="row justify-content-between">
                <div class="col-sm-12 col-md-4 order-md-1 order-last">
                    <h3><i class="bi bi-file-earmark-ruled"></i> Vacaciones de {{$user->name. ' ' . $user->surname}}</h3>
                ...
                <div class="col-sm-12 col-md-4 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Gestión de vacaciones por usuario</li>
                        </ol>
                    </nav>
        ...
        <div class="row">
            <div class="col-lg col-md-4 mt-4">
                <div class="card2">
                    <div class="card-body ">
                        <div class="col-12" style="text-align: center">
                            <p for="">&nbsp;</p>
                            @if( $numberOfholidaysPetitions == 1)
                                <p for="pendant">Tienes <span style="color:red"><strong>{{ $numberOfholidaysPetitions }}</strong></span> petición pendiente</p>
                            @else
                                <p for="pendant">Tienes <span style="color:red"><strong>{{ $numberOfholidaysPetitions }}</strong></span> peticiones pendientes</p>
                            @endif
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg col-md-4 mt-4">
                <div class="card2">
                    <div class="card-body ">
                        <div class="col-12" style="text-align: center">
                                <p for="pendant">Dias disponibles: <strong>{{ $diasDisponibles }}</strong></p>
                                <p for="pendant">Dias disfrutados: <strong>{{ $diasDisfrutados }}</strong></p>
                        </div>
                    </div>
                </div>
            </div>
