                            ...
                            <div class="col">
                                <div class="card2">
                                    <div class="mb-3 card-body">
                                        ...
                                        <a target="_blank" href="{{route('logs.kitdigital')}}" class="btn btn-outline-secondary mb-2">Kit Digital Estados</a>
                                        <a target="_blank" href="{{ route('kitDigital.sin_actualizar') }}" class="btn btn-outline-secondary mb-2"> Kit Digitales Sin Actualizar</a>
                                        <a target="_blank" href="{{ route('kitDigital.pagados') }}" class="btn btn-outline-secondary mb-2"> Kit Digitales Pagados</a>
